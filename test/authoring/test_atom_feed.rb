...
class AtomFeedTest < Minitest::Test
  def test_renders_recent_non_empty_published_pages_with_body_html
    article = page(
      ...
      published_at: Time.iso8601("2026-08-21T09:00:00+09:00")
    )
    ...
    assert_includes feed, "<id>https://weblog.ason.as/</id>"
    assert_includes feed, "<updated>2026-08-23T12:00:00+09:00</updated>"
    assert_includes feed, "<title>記事 &amp; 一覧</title>"
    assert_includes feed, "<published>2026-08-21T09:00:00+09:00</published>"
    assert_includes feed, "本文 &lt;strong&gt;です&lt;/strong&gt;"
    assert_includes feed, "href=&quot;https://weblog.ason.as/%E9%96%A2%E9%80%A3&quot;"
    article_url = "https://weblog.ason.as/%E8%A8%98%E4%BA%8B%20%26%20%E4%B8%80%E8%A6%A7"
    assert_includes feed, %(<link rel="alternate" type="text/html" href="#{article_url}" />)
