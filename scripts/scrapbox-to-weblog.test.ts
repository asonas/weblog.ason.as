...
test("converts downloaded Gyazo images to local Markdown images", () => {
  const imagePaths = new Map([
    [
      "https://gyazo.com/407f28423dcc6ad4913886cabc6c7091",
  ...
  assert.equal(
    convertLine(
      "[https://gyazo.com/407f28423dcc6ad4913886cabc6c7091 caption]",
      imagePaths,
    ),
    "![](/assets/asset_00306fc8470742b6.jpg)",
  );
  ...
  const paths = buildImagePaths(
      ...
      assets: [
        {
          id: "asset_downloaded",
          kind: "image",
          url: "https://gyazo.com/downloaded",
        },
    ...
    },
    {
      results: [
        {
          id: "asset_downloaded",
          local_path: "asset_downloaded.jpg",
          status: "downloaded",
        },
        { id: "asset_failed", status: "failed" },
        {
          id: "asset_page",
          local_path: "asset_page.html",
          status: "downloaded",
        },
      ],
    },
