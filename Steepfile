target :domain do
  ...
  check "lib/weblog_authoring/diary_navigation.rb"
  ...
  check "lib/weblog_authoring/lambda_session.rb"
  check "lib/weblog_authoring/github_oauth.rb"
  check "lib/weblog_authoring/lambda_api.rb"
end
