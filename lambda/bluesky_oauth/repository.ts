...
export interface OAuthRepository {
  ...
  saveSession(did: string, value: string, status?: OAuthConnectionStatus): Promise<void>;
  getSession(did: string): Promise<{ value: string; status: OAuthConnectionStatus } | undefined>;
...
export class MemoryOAuthRepository implements OAuthRepository {
  private readonly states = new Map<string, { value: string; expiresAt: Date }>();
  private readonly sessions = new Map<string, { value: string; status: OAuthConnectionStatus }>();
